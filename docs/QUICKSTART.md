# Standard helm library quickstart guide

The helm standard library supports helm3 identified by the  `apiVersion: v2` in your `Chart.yaml`

## Install

### Install the helm standard library

```
helm repo add https://kubefabrics.github.io/std-helm/
helm repo update
```

### Install the standard library Helm plugin

helm plugin install https://kubefabrics.github.io/stdhelm/

### Genrerate you application scaffolding

helm sdtheml create deployment myapp
helm sdtheml create deployment myapp

helm dependency update <your_chart_location-directory>
